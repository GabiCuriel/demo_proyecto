...
<html>
    ...
    <?php
        try
        {
            ...
            $conMySQL = new PDO("mysql:host=localhost; port=3306; dbname=restaurante1", "root","");
            # PDO::set Attribute - Establece un atributo.
            $conMySQL->setAttribute(PDO::ATTR_ERRMODE, PDO::ERRMODE_EXCEPTION);
            $conMySQL->exec("SET CHARACTER SET UTF8");
            $sentenciasSQL = "SELECT * FROM clientes WHERE USUARIO = :login AND PASSWORD = :passw";
           ...
           $pas=htmlspecialchars(addslashes($_POST["contrasena"]));
